...
// repeated .fixbug.User friendsList = 2;
inline int GetFriendListsResponse::_internal_friendslist_size() const {
  return friendslist_.size();
}
inline int GetFriendListsResponse::friendslist_size() const {
  return _internal_friendslist_size();
}
inline void GetFriendListsResponse::clear_friendslist() {
  friendslist_.Clear();
}
inline ::fixbug::User* GetFriendListsResponse::mutable_friendslist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.friendsList)
  return friendslist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_friendslist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.friendsList)
  return &friendslist_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_friendslist(int index) const {
  return friendslist_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::friendslist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.friendsList)
  return _internal_friendslist(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_friendslist() {
  return friendslist_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_friendslist() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.friendsList)
  return _internal_add_friendslist();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::friendslist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.friendsList)
  return friendslist_;
}
